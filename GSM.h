...
#define GSM_LIB_VERSION 100 // library version X.YY (e.g. 1.00)
...
// pins definition
#define GSM_ON              15 // connect GSM Module turn ON to pin 77 
#define GSM_RESET           16 // connect GSM Module RESET to pin 35
...
class GSM
{
  ...
  public:
	...
	byte no_of_attempts);
	char SendATCmdWaitResp(__FlashStringHelper* AT_cmd_string,
    uint16_t start_comm_tmout, uint16_t max_interchar_tmout,
    char const *response_string,
    byte no_of_attempts);
